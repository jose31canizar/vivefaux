...
class Contact extends Component {
  ...
  handleSubmit(event) {
    console.log('A name was submitted: ' + this.state.email + this.state.firstName + this.state.lastName + this.state.message + this.state.subject)
    this.addMember()
      ...
      <div className='contact-page'>
        ...
        <div className='section'>
          ...
          <form className='contact-form' onSubmit={this.handleSubmit}>
            <h4>Subject</h4>
            <input placeholder="subject" type="text" value={this.state.subject} onChange={this.handleSubject}/>
            ...
            <input placeholder="last name" type="text" value={this.state.lastName} onChange={this.handleLastName}/>
            <h4>Email Address</h4>
            <input placeholder="email" type="email" value={this.state.email} onChange={this.handleEmail}/>
            <h4>Message</h4>
            <textarea rows="10" cols="50" value={this.state.message} onChange={this.handleMessage}/>
